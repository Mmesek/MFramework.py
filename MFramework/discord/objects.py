...
def as_dict(object):
    if type(object) is dict:
        for key in object:
            object[key] = as_dict(object[key])
    elif type(object) is list:
        object = [as_dict(key) for key in object]
...
class Message(DiscordObject):
    ...
    ***** This field is only returned for messages with a `type` of `19` (REPLY). If the message is a reply but the `referenced_message` field is not present, the backend did not attempt to fetch the message that was being replied to, so its state is unknown. If the field exists but is null, the referenced message was deleted.
    ...
    async def reply(self, Client, content="", embeds=[]):
        return await create_message(Client, self.channel_id,
    ...
    async def delete(self, Client):
        return await delete_message(Client, self.channel_id, self.message_id)
    
    async def edit(self, Client):
        return await edit_message(Client, self.channel_id, self.message_id, self.content, self.embeds[0], self.flags, self.allowed_mentions)
    
    async def send(self, Client):
        return await create_message(Client, self.channel_id, content=self.content, embed=self.embeds[0])
    
    async def webhook(self, Client, webhook_id: Snowflake, webhook_token: int, username: str = None, avatar_url: str = None, file: bytes = None):
        return await execute_webhook(Client, webhook_id, webhook_token, content=self.content, username=username, avatar_url=avatar_url, file=file, embeds=self.embeds, allowed_mentions=self.allowed_mentions)
    
    async def webhook_edit(self, Client, webhook_id, webhook_token, content: str = None, embeds: List[Embed] = None, allowed_mentions: Allowed_Mentions = None):
        return await edit_webhook_message(Client, webhook_id, webhook_token, self.message_id, content, embeds, allowed_mentions)
    
    async def get(self, Client):
        return await get_channel_message(Client, self.channel_id, self.message_id)

    async def react(self, Client, reaction):
        return await create_reaction(Client, self.channel_id, self.message_id, reaction)
    
    async def delete_reaction(self, Client, reaction):
        return await delete_own_reaction(Client, self.channel_id, self.message_id, reaction)
...
class Embed(DiscordObject):
    ...
    def total_characters(self):
        return len(self.title) + len(self.description) + len(self.author.name) + len(self.footer.text) + sum([len(field.name) + len(field.value) for field in self.fields])
...
class Interaction(DiscordObject):
    ...
    * This is always present on `ApplicationCommand` interaction types. It is optional for future-proofing against new interaction types
    ...
    token: str = ''
    version: int = 0
    async def pong(self, Client):
        response = Interaction_Response(
            Interaction_Response_Type.PONG,
            None
        )
        return await create_interaction_response(Client, self.id, self.token, response)
    async def ack(self, Client):
        response = Interaction_Response(
            Interaction_Response_Type.ACKNOWLEDGE,
            None
        )
        return await create_interaction_response(Client, self.id, self.token, response)
    async def respond(self, Client, response: Interaction_Response):
        return await create_interaction_response(Client, self.id, self.token, response)
    async def edit_response(self, Client, content: str = None, embeds: List[Embed] = None, allowed_mentions: Allowed_Mentions = None):
        return await edit_original_interaction_response(Client, Client.application.id, self.token, content, embeds, allowed_mentions)
    async def delete_response(self, Client):
        return await delete_original_interaction_response(Client, Client.application.id, self.token)
    async def reply(self, Client, content: str = None, username: str = None, avatar_url: str = None, tts: bool = None, file: bytes = None, filename=None, embeds: List[Embed] = None, payload_json: str = None, allowed_mentions: Allowed_Mentions = [], wait: bool = False):
        return await create_followup_message(Client, Client.application.id, self.token, wait=wait, content=content, username=username, avatar_url=avatar_url, tts=tts, file=file, filename=filename, embeds=embeds, payload_json=payload_json, allowed_mentions=allowed_mentions)
    async def edit(self, Client, message_id, content: str = None, embeds: List[Embed] = None, allowed_mentions: Allowed_Mentions = []):
        return await edit_followup_message(Client, Client.application.id, self.token, message_id, content, embeds, allowed_mentions)
    async def delete(self, Client, message_id):
        return await delete_followup_message(Client, Client.application.id, self.token, message_id)
...
async def get_guild_audit_log(Client, guild_id: Snowflake, user_id: Snowflake, action_type: int, before: int, limit: int) -> Audit_Log:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/audit-logs", method = "GET", params = {"user_id": user_id, "action_type": action_type, "before": before, "limit": limit})
    return Audit_Log(**r)

async def get_channel(Client, channel_id: Snowflake) -> Channel:
    '''
    Get a channel by ID. Returns a [channel](https://discord.com/developers/docs/resources/channel#channel-object) object.
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}", method = "GET")
    return Channel(**r)

@Permissions("MANAGE_CHANNELS")
async def modify_channel(Client, channel_id: Snowflake, name: str, type: int, position: int=None, topic: str=None, nsfw: bool=None, rate_limit_per_user: int=None, bitrate: int=None, user_limit: int=None, permission_overwrites: List[Overwrite]=None, parent_id: Snowflake=None) -> Channel:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}", method = "PATCH", json = {"name": name, "type": type, "position": position, "topic": topic, "nsfw": nsfw, "rate_limit_per_user": rate_limit_per_user, "bitrate": bitrate, "user_limit": user_limit, "permission_overwrites": permission_overwrites, "parent_id": parent_id})
    return Channel(**r)

@Permissions("MANAGE_CHANNELS")
async def delete_close_channel(Client, channel_id: Snowflake) -> Channel:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}", method = "DELETE")
    return Channel(**r)

@Permissions("VIEW_CHANNEL")
async def get_channel_messages(Client, channel_id: Snowflake, around: int=None, before: int=None, after: int=None, limit: int=50) -> List[Message]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/messages", method = "GET", params = {"around": around, "before": before, "after": after, "limit": limit})
    return [Message(**i) for i in r]

@Permissions("READ_MESSAGE_HISTORY")
async def get_channel_message(Client, channel_id: Snowflake, message_id: Snowflake) -> Message:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}", method = "GET")
    return Message(**r)

@Permissions("SEND_MESSAGES", "READ_MESSAGE_HISTORY")
async def create_message(Client, channel_id: Snowflake=None, content: str=None, nonce: int=None, tts: bool=None, file: bytes=None, embed: Embed=None, payload_json: str=None, allowed_mentions: Allowed_Mentions=None, message_reference: Message_Reference=None) -> Message:
    '''
    > warn
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/messages", method = "POST", json = {"content": content, "nonce": nonce, "tts": tts, "file": file, "embed": embed, "payload_json": payload_json, "allowed_mentions": allowed_mentions, "message_reference": message_reference})
    return Message(**r)

@Permissions("SEND_MESSAGES")
async def crosspost_message(Client, channel_id: Snowflake, message_id: Snowflake) -> Message:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/crosspost", method = "POST")
    return Message(**r)

@Permissions("READ_MESSAGE_HISTORY", "ADD_REACTIONS")
async def create_reaction(Client, channel_id: Snowflake, message_id: Snowflake, emoji: str) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/@me", method = "PUT")

async def delete_own_reaction(Client, channel_id: Snowflake, message_id: Snowflake, emoji: int) -> None:
    '''
    Delete a reaction the current user has made for the message. Returns a 204 empty response on success.
    The `emoji` must be [URL Encoded](https:#/en.wikipedia.org/wiki/Percent-encoding) or the request will fail with `10014: Unknown Emoji`.
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/@me", method = "DELETE")

@Permissions("MANAGE_MESSAGES")
async def delete_user_reaction(Client, channel_id: Snowflake, message_id: Snowflake, emoji: int, user_id: Snowflake) -> None:
    '''
    ...
    The `emoji` must be [URL Encoded](https:#/en.wikipedia.org/wiki/Percent-encoding) or the request will fail with `10014: Unknown Emoji`.
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/reactions/{emoji}/{user_id}", method = "DELETE")

async def get_reactions(Client, channel_id: Snowflake, message_id: Snowflake, emoji: int, before: int=None, after: int=None, limit: int=25) -> List[User]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/reactions/{emoji}", method = "GET", params = {"before": before, "after": after, "limit": limit})
    return [User(**i) for i in r]

@Permissions("MANAGE_MESSAGES")
async def delete_all_reactions(Client, channel_id: Snowflake, message_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/reactions", method = "DELETE")

@Permissions("MANAGE_MESSAGES")
async def delete_all_reactions_for_emoji(Client, channel_id: Snowflake, message_id: Snowflake, emoji: int) -> None:
    '''
    ...
    The `emoji` must be [URL Encoded](https:#/en.wikipedia.org/wiki/Percent-encoding) or the request will fail with `10014: Unknown Emoji`.
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}/reactions/{emoji}", method = "DELETE")

async def edit_message(Client, channel_id: Snowflake, message_id: Snowflake, content: str, embed: Embed, flags: int, allowed_mentions: Allowed_Mentions) -> Message:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}", method = "PATCH", json = {"content": content, "embed": embed, "flags": flags, "allowed_mentions": allowed_mentions})
    return Message(**r)

@Permissions("MANAGE_MESSAGES")
async def delete_message(Client, channel_id: Snowflake, message_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/{message_id}", method = "DELETE")

@Permissions("MANAGE_MESSAGES")
async def bulk_delete_messages(Client, channel_id: Snowflake, messages: List[int]) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/messages/bulk-delete", method = "POST", json = {"messages": messages})

@Permissions("MANAGE_ROLES")
async def edit_channel_permissions(Client, channel_id: Snowflake, overwrite_id: Snowflake, allow: str, deny: str, type: int) -> None:
    '''
    ...
    Params:
        ...
        :type: 0 for a role
    '''
    await Client.api_call(path = f"/channels/{channel_id}/permissions/{overwrite_id}", method = "PUT", json = {"allow": allow, "deny": deny, "type": type})

@Permissions("MANAGE_CHANNELS")
async def get_channel_invites(Client, channel_id: Snowflake) -> List[Invite]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/invites", method = "GET")
    return [Invite(**i) for i in r]

@Permissions("CREATE_INSTANT_INVITE")
async def create_channel_invite(Client, channel_id: Snowflake, max_age: int=86400, max_uses: int=0, temporary: bool=False, unique: bool=False, target_user: str=None, target_user_type: int=None) -> Invite:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/invites", method = "POST", json = {"max_age": max_age, "max_uses": max_uses, "temporary": temporary, "unique": unique, "target_user": target_user, "target_user_type": target_user_type})
    return Invite(**r)

@Permissions("MANAGE_ROLES")
async def delete_channel_permission(Client, channel_id: Snowflake, overwrite_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/permissions/{overwrite_id}", method = "DELETE")

@Permissions("MANAGE_WEBHOOKS")
async def follow_news_channel(Client, channel_id: Snowflake, webhook_channel_id: Snowflake) -> Followed_Channel:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/followers", method = "POST", json = {"webhook_channel_id": webhook_channel_id})
    return Followed_Channel(**r)

async def trigger_typing_indicator(Client, channel_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/typing", method = "POST")

async def get_pinned_messages(Client, channel_id: Snowflake) -> Message:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/pins", method = "GET")
    return Message(**r)

@Permissions("MANAGE_MESSAGES")
async def add_pinned_channel_message(Client, channel_id: Snowflake, message_id: Snowflake) -> None:
    '''
    Pin a message in a channel. Requires the `MANAGE_MESSAGES` permission. Returns a 204 empty response on success.
    > warn
    > The max pinned messages is 50.
    '''
    await Client.api_call(path = f"/channels/{channel_id}/pins/{message_id}", method = "PUT")

@Permissions("MANAGE_MESSAGES")
async def delete_pinned_channel_message(Client, channel_id: Snowflake, message_id: Snowflake) -> None:
    '''
    Delete a pinned message in a channel. Requires the `MANAGE_MESSAGES` permission. Returns a 204 empty response on success.
    '''
    await Client.api_call(path = f"/channels/{channel_id}/pins/{message_id}", method = "DELETE")

async def group_dm_add_recipient(Client, channel_id: Snowflake, user_id: Snowflake, access_token: str, nick: str) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/channels/{channel_id}/recipients/{user_id}", method = "PUT", json = {"access_token": access_token, "nick": nick})

async def group_dm_remove_recipient(Client, channel_id: Snowflake, user_id: Snowflake) -> None:
    '''
    Removes a recipient from a Group DM
    '''
    await Client.api_call(path = f"/channels/{channel_id}/recipients/{user_id}", method = "DELETE")

async def list_guild_emojis(Client, guild_id: Snowflake) -> List[Emoji]:
    '''
    Returns a list of [emoji](https://discord.com/developers/docs/resources/emoji#emoji-object) objects for the given guild.
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/emojis", method = "GET")
    return [Emoji(**i) for i in r]

async def get_guild_emoji(Client, guild_id: Snowflake, emoji_id: Snowflake) -> Emoji:
    '''
    Returns an [emoji](https://discord.com/developers/docs/resources/emoji#emoji-object) object for the given guild and emoji IDs.
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/emojis/{emoji_id}", method = "GET")
    return Emoji(**r)

@Permissions("MANAGE_EMOJIS")
async def create_guild_emoji(Client, guild_id: Snowflake, name: str, image: str, roles: List[int]) -> Emoji:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/emojis", method = "POST", json = {"name": name, "image": image, "roles": roles})
    return Emoji(**r)

@Permissions("MANAGE_EMOJIS")
async def modify_guild_emoji(Client, guild_id: Snowflake, emoji_id: Snowflake, name: str, roles: List[int]=None) -> Emoji:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/emojis/{emoji_id}", method = "PATCH", json = {"name": name, "roles": roles})
    return Emoji(**r)

@Permissions("MANAGE_EMOJIS")
async def delete_guild_emoji(Client, guild_id: Snowflake, emoji_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/emojis/{emoji_id}", method = "DELETE")

async def create_guild(Client, name: str, region: str=None, icon: str=None, verification_level: int=None, default_message_notifications: int=None, explicit_content_filter: int=None, roles: List[Role]=None, channels: List[Channel]=None, afk_channel_id: Snowflake=None, afk_timeout: int=None, system_channel_id: Snowflake=None) -> Guild:
    '''
...
async def get_guild(Client, guild_id: Snowflake, with_counts: bool=False) -> Guild:
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}", method = "GET", params = {"with_counts": with_counts})
    return Guild(**r)

async def get_guild_preview(Client, guild_id: Snowflake) -> Guild_Preview:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/preview", method = "GET")
    return Guild_Preview(**r)

@Permissions("MANAGE_GUILD")
async def modify_guild(Client, guild_id: Snowflake, name: str, afk_timeout: int, icon: str, owner_id: Snowflake, splash: str, banner: str, region: str=None, verification_level: int=None, default_message_notifications: int=None, explicit_content_filter: int=None, afk_channel_id: Snowflake=None, system_channel_id: Snowflake=None, rules_channel_id: Snowflake=None, public_updates_channel_id: Snowflake=None, preferred_locale: str=None) -> Guild:
    '''
    ...
    Params:
        ...
        :preferred_locale: the preferred locale of a Community guild used in server discovery and notices from Discord; defaults to "en-US"
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}", method = "PATCH", json = {"name": name, "region": region, "verification_level": verification_level, "default_message_notifications": default_message_notifications, "explicit_content_filter": explicit_content_filter, "afk_channel_id": afk_channel_id, "afk_timeout": afk_timeout, "icon": icon, "owner_id": owner_id, "splash": splash, "banner": banner, "system_channel_id": system_channel_id, "rules_channel_id": rules_channel_id, "public_updates_channel_id": public_updates_channel_id, "preferred_locale": preferred_locale})
    return Guild(**r)

async def delete_guild(Client, guild_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}", method = "DELETE")

async def get_guild_channels(Client, guild_id: Snowflake) -> List[Channel]:
    '''
    Returns a list of guild [channel](https://discord.com/developers/docs/resources/channel#channel-object) objects.
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/channels", method = "GET")
    return [Channel(**i) for i in r]

@Permissions("MANAGE_CHANNELS")
async def create_guild_channel(Client, guild_id: Snowflake, name: str, type: int, topic: str, bitrate: int, user_limit: int, rate_limit_per_user: int, position: int, permission_overwrites: List[Overwrite], parent_id: Snowflake, nsfw: bool) -> Channel:
    '''
    ...
    Params:
        ...
        :nsfw: whether the channel is nsfw
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/channels", method = "POST", json = {"name": name, "type": type, "topic": topic, "bitrate": bitrate, "user_limit": user_limit, "rate_limit_per_user": rate_limit_per_user, "position": position, "permission_overwrites": permission_overwrites, "parent_id": parent_id, "nsfw": nsfw})
    return Channel(**r)

async def modify_guild_channel_positions(Client, guild_id: Snowflake, id: Snowflake, position: int=None) -> None:
    '''
    ...
    Params:
        ...
        :position: sorting position of the channel
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/channels", method = "PATCH", json = {"id": id, "position": position})

async def get_guild_member(Client, guild_id: Snowflake, user_id: Snowflake) -> Guild_Member:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/members/{user_id}", method = "GET")
    return Guild_Member(**r)

async def list_guild_members(Client, guild_id: Snowflake, limit: int=1, after: int=0) -> List[Guild_Member]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/members", method = "GET", params = {"limit": limit, "after": after})
    return [Guild_Member(**i) for i in r]

async def add_guild_member(Client, guild_id: Snowflake, user_id: Snowflake, access_token: str, nick: str, roles: List[int], mute: bool, deaf: bool) -> Guild_Member:
    '''
    ...
    Params:
        ...
        :deaf: whether the user is deafened in voice channels
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/members/{user_id}", method = "PUT", json = {"access_token": access_token, "nick": nick, "roles": roles, "mute": mute, "deaf": deaf})
    return Guild_Member(**r)

async def modify_guild_member(Client, guild_id: Snowflake, user_id: Snowflake, nick: str, roles: List[int], mute: bool, deaf: bool, channel_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/members/{user_id}", method = "PATCH", json = {"nick": nick, "roles": roles, "mute": mute, "deaf": deaf, "channel_id": channel_id})

async def modify_current_user_nick(Client, guild_id: Snowflake, nick: str=None) -> str:
    '''
    ...
    Params:
        :nick: value to set users nickname to
    '''
    return await Client.api_call(path = f"/guilds/{guild_id}/members/@me/nick", method = "PATCH", json = {"nick": nick})

@Permissions("MANAGE_ROLES")
async def add_guild_member_role(Client, guild_id: Snowflake, user_id: Snowflake, role_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/members/{user_id}/roles/{role_id}", method = "PUT")

@Permissions("MANAGE_ROLES")
async def remove_guild_member_role(Client, guild_id: Snowflake, user_id: Snowflake, role_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/members/{user_id}/roles/{role_id}", method = "DELETE")

async def remove_guild_member(Client, guild_id: Snowflake, user_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/members/{user_id}", method = "DELETE")

@Permissions("BAN_MEMBERS")
async def get_guild_bans(Client, guild_id: Snowflake) -> List[Ban]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/bans", method = "GET")
    return [Ban(**i) for i in r]

@Permissions("BAN_MEMBERS")
async def get_guild_ban(Client, guild_id: Snowflake, user_id: Snowflake) -> Ban:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/bans/{user_id}", method = "GET")
    return Ban(**r)

@Permissions("BAN_MEMBERS")
async def create_guild_ban(Client, guild_id: Snowflake, user_id: Snowflake, delete_message_days: int=None, reason: str=None) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/bans/{user_id}", method = "PUT", json = {"delete_message_days": delete_message_days, "reason": reason})

@Permissions("BAN_MEMBERS")
async def remove_guild_ban(Client, guild_id: Snowflake, user_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/bans/{user_id}", method = "DELETE")

async def get_guild_roles(Client, guild_id: Snowflake) -> List[Role]:
    '''
    Returns a list of [role](https://discord.com/developers/docs/topics/permissions#role-object) objects for the guild.
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/roles", method = "GET")
    return [Role(**i) for i in r]

@Permissions("MANAGE_ROLES")
async def create_guild_role(Client, guild_id: Snowflake, name: str="new_role", permissions: str="@everyone_permissions_in_guild", color: int=0, hoist: bool=False, mentionable: bool=False) -> Role:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/roles", method = "POST", json = {"name": name, "permissions": permissions, "color": color, "hoist": hoist, "mentionable": mentionable})
    return Role(**r)

@Permissions("MANAGE_ROLES")
async def modify_guild_role_positions(Client, guild_id: Snowflake, id: Snowflake, position: int=None) -> List[Role]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/roles", method = "PATCH", json = {"id": id, "position": position})
    return [Role(**i) for i in r]

@Permissions("MANAGE_ROLES")
async def modify_guild_role(Client, guild_id: Snowflake, role_id: Snowflake, name: str, permissions: str, color: int, hoist: bool, mentionable: bool) -> Role:
    '''
    ...
    Params:
        ...
        :mentionable: whether the role should be mentionable
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/roles/{role_id}", method = "PATCH", json = {"name": name, "permissions": permissions, "color": color, "hoist": hoist, "mentionable": mentionable})
    return Role(**r)

@Permissions("MANAGE_ROLES")
async def delete_guild_role(Client, guild_id: Snowflake, role_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/roles/{role_id}", method = "DELETE")

@Permissions("KICK_MEMBERS")
async def get_guild_prune_count(Client, guild_id: Snowflake, days: int=7, include_roles: List[int]=None) -> dict:
    '''
    ...
    Params:
        ...
        :include_roles: role
    '''
    return await Client.api_call(path = f"/guilds/{guild_id}/prune", method = "GET", params = {"days": days, "include_roles": include_roles})

@Permissions("KICK_MEMBERS")
async def begin_guild_prune(Client, guild_id: Snowflake, days: int=7, compute_prune_count: bool=True, include_roles: List[int]=None) -> None:
    '''
    ...
    Params:
        ...
        :include_roles: role
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/prune", method = "POST", json = {"days": days, "compute_prune_count": compute_prune_count, "include_roles": include_roles})

async def get_guild_voice_regions(Client, guild_id: Snowflake) -> List[Voice_Region]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/regions", method = "GET")
    return [Voice_Region(**i) for i in r]

@Permissions("MANAGE_GUILD")
async def get_guild_invites(Client, guild_id: Snowflake) -> List[Invite]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/invites", method = "GET")
    return [Invite(**i) for i in r]

@Permissions("MANAGE_GUILD")
async def get_guild_integrations(Client, guild_id: Snowflake) -> List[Integration]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/integrations", method = "GET")
    return [Integration(**i) for i in r]

@Permissions("MANAGE_GUILD")
async def create_guild_integration(Client, guild_id: Snowflake, type: str, id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/integrations", method = "POST", json = {"type": type, "id": id})

@Permissions("MANAGE_GUILD")
async def modify_guild_integration(Client, guild_id: Snowflake, integration_id: Snowflake, expire_behavior: int, expire_grace_period: int, enable_emoticons: bool) -> None:
    '''
    ...
    Params:
        ...
        :enable_emoticons: whether emoticons should be synced for this integration
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/integrations/{integration_id}", method = "PATCH", json = {"expire_behavior": expire_behavior, "expire_grace_period": expire_grace_period, "enable_emoticons": enable_emoticons})

@Permissions("MANAGE_GUILD")
async def delete_guild_integration(Client, guild_id: Snowflake, integration_id: Snowflake) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/integrations/{integration_id}", method = "DELETE")

@Permissions("MANAGE_GUILD")
async def sync_guild_integration(Client, guild_id: Snowflake, integration_id: Snowflake) -> None:
    '''
    Sync an integration. Requires the `MANAGE_GUILD` permission. Returns a 204 empty response on success.
    '''
    await Client.api_call(path = f"/guilds/{guild_id}/integrations/{integration_id}/sync", method = "POST")

@Permissions("MANAGE_GUILD")
async def get_guild_widget_settings(Client, guild_id: Snowflake) -> Guild_Widget:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/widget", method = "GET")
    return Guild_Widget(**r)

@Permissions("MANAGE_GUILD")
async def modify_guild_widget(Client, guild_id: Snowflake) -> Guild_Widget:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/widget", method = "PATCH")
    return Guild_Widget(**r)

async def get_guild_widget(Client, guild_id: Snowflake) -> Guild_Widget:
    '''
    Returns the widget for the guild.
    '''
    r = await Client.api_call(path=f"/guilds/{guild_id}/widget_json", method="GET")
    return Guild_Widget(**r)

@Permissions("MANAGE_GUILD")
async def get_guild_vanity_url(Client, guild_id: Snowflake) -> Invite:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/vanity-url", method = "GET")
    return Invite(**r)

async def get_guild_widget_image(Client, guild_id: Snowflake, style: str="shield") -> str:
    '''
    ...
    '''
    return await Client.api_call(path = f"/guilds/{guild_id}/widget_png", method = "GET", params = {"style": style})

async def get_invite(Client, invite_code: int, with_counts: bool=None) -> Invite:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/invites/{invite_code}", method = "GET", json = {"with_counts": with_counts})
    return Invite(**r)

@Permissions("MANAGE_CHANNELS")
async def delete_invite(Client, invite_code: int) -> Invite:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/invites/{invite_code}", method = "DELETE")
    return Invite(**r)

async def get_current_user(Client) -> User:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me", method = "GET")
    return User(**r)

async def get_user(Client, user_id: Snowflake) -> User:
    '''
    Returns a [user](https://discord.com/developers/docs/resources/user#user-object) object for a given user ID.
    '''
    r = await Client.api_call(path = f"/users/{user_id}", method = "GET")
    return User(**r)

async def modify_current_user(Client, username: str, avatar: str) -> User:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me", method = "PATCH", json = {"username": username, "avatar": avatar})
    return User(**r)

async def get_current_user_guilds(Client) -> List[Guild]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me/guilds", method = "GET")
    return [Guild(**i) for i in r]

async def leave_guild(Client, guild_id: Snowflake) -> None:
    '''
    Leave a guild. Returns a 204 empty response on success.
    '''
    await Client.api_call(path = f"/users/@me/guilds/{guild_id}", method = "DELETE")

async def get_user_dms(Client) -> List[Channel]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me/channels", method = "GET")
    return [Channel(**i) for i in r]

async def create_dm(Client, recipient_id: Snowflake) -> Channel:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me/channels", method = "POST", json = {"recipient_id": recipient_id})
    return Channel(**r)

async def create_group_dm(Client, access_tokens: List[str], nicks: dict) -> Channel:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me/channels", method = "POST", json = {"access_tokens": access_tokens, "nicks": nicks})
    return Channel(**r)

async def get_user_connections(Client) -> List[Connection]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/users/@me/connections", method = "GET")
    return [Connection(**i) for i in r]

async def list_voice_regions(Client) -> List[Voice_Region]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/voice/regions", method = "GET")
    return [Voice_Region(**i) for i in r]

@Permissions("MANAGE_WEBHOOKS")
async def create_webhook(Client, channel_id: Snowflake, name: str, avatar: str) -> Webhook:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/webhooks", method = "POST", json = {"name": name, "avatar": avatar})
    return Webhook(**r)

@Permissions("MANAGE_WEBHOOKS")
async def get_channel_webhooks(Client, channel_id: Snowflake) -> List[Webhook]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/channels/{channel_id}/webhooks", method = "GET")
    return [Webhook(**i) for i in r]

@Permissions("MANAGE_WEBHOOKS")
async def get_guild_webhooks(Client, guild_id: Snowflake) -> List[Webhook]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/guilds/{guild_id}/webhooks", method = "GET")
    return [Webhook(**i) for i in r]

async def get_webhook(Client, webhook_id: Snowflake) -> Webhook:
    '''
    Returns the new [webhook](https://discord.com/developers/docs/resources/webhook#webhook-object) object for the given id.
    '''
    r = await Client.api_call(path = f"/webhooks/{webhook_id}", method = "GET")
    return Webhook(**r)

async def get_webhook_with_token(Client, webhook_id: Snowflake, webhook_token: int) -> None:
    '''
    Same as above, except this call does not require authentication and returns no user in the webhook object.
    '''
    r = await Client.api_call(path=f"/webhooks/{webhook_id}/{webhook_token}", method="GET")
    return Webhook(**r)

@Permissions("MANAGE_WEBHOOKS")
async def modify_webhook(Client, webhook_id: Snowflake, name: str, avatar: str, channel_id: Snowflake) -> Webhook:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/webhooks/{webhook_id}", method = "PATCH", json = {"name": name, "avatar": avatar, "channel_id": channel_id})
    return Webhook(**r)

async def modify_webhook_with_token(Client, webhook_id: Snowflake, webhook_token: int) -> None:
    '''
    Same as above, except this call does not require authentication, does not accept a `channel_id` parameter in the body, and does not return a user in the webhook object.
    '''
    r = await Client.api_call(path=f"/webhooks/{webhook_id}/{webhook_token}", method="PATCH")
    return Webhook(**r)

@Permissions("MANAGE_WEBHOOKS")
async def delete_webhook(Client, webhook_id: Snowflake) -> None:
    '''
    Delete a webhook permanently. Requires the `MANAGE_WEBHOOKS` permission. Returns a 204 NO CONTENT response on success.
    '''
    await Client.api_call(path = f"/webhooks/{webhook_id}", method = "DELETE")

async def delete_webhook_with_token(Client, webhook_id: Snowflake, webhook_token: int) -> None:
    '''
...
async def execute_slack_compatible_webhook(Client, webhook_id: Snowflake, webhook_token: int, wait: bool) -> None:
    ...
    '''
    await Client.api_call(path = f"/webhooks/{webhook_id}/{webhook_token}/slack", method = "POST", params = {"wait": wait})

async def execute_github_compatible_webhook(Client, webhook_id: Snowflake, webhook_token: int, wait: bool) -> None:
    '''
    Params:
        :wait: waits for server confirmation of message send before response
    '''
    await Client.api_call(path = f"/webhooks/{webhook_id}/{webhook_token}/github", method = "POST", params = {"wait": wait})

async def edit_webhook_message(Client, webhook_id: Snowflake, webhook_token: int, message_id: Snowflake, content: str, embeds: List[Embed], allowed_mentions: Allowed_Mentions) -> None:
    '''
    ...
    Params:
        ...
        :allowed_mentions: allowed mentions for the message
    '''
    await Client.api_call(path = f"/webhooks/{webhook_id}/{webhook_token}/messages/{message_id}", method = "PATCH", json = {"content": content, "embeds": embeds, "allowed_mentions": allowed_mentions})

async def get_gateway(Client) -> dict:
    '''
    > info
    ...
    '''
    return await Client.api_call(path = f"/gateway", method = "GET")

async def get_gateway_bot(Client) -> dict:
    '''
    > warn
    ...
    '''
    return await Client.api_call(path = f"/gateway/bot", method = "GET")

async def get_current_application_information(Client) -> None:
    '''
    ...
    '''
    r = await Client.api_call(path=f"/oauth2/applications/@me", method="GET")
    return Application(**r)

async def get_global_application_commands(Client, application_id: Snowflake) -> List[Application_Command]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/applications/{application_id}/commands", method = "GET")
    return [Application_Command(**i) for i in r]

async def create_global_application_command(Client, application_id: Snowflake, name: str, description: str, options: List[Application_Command_Option]=None) -> Application_Command:
    '''
    > danger
    ...
    Params:
        ...
        :options: the parameters for the command
    '''
    r = await Client.api_call(path = f"/applications/{application_id}/commands", method = "POST", json = {"name": name, "description": description, "options": options})
    return Application_Command(**r)

async def edit_global_application_command(Client, application_id: Snowflake, command_id: Snowflake, name: str, description: str, options: List[Application_Command_Option]=None) -> Application_Command:
    '''
    ...
    Params:
        ...
        :options: the parameters for the command
    '''
    r = await Client.api_call(path = f"/applications/{application_id}/commands/{command_id}", method = "PATCH", json = {"name": name, "description": description, "options": options})
    return Application_Command(**r)

async def delete_global_application_command(Client, application_id: Snowflake, command_id: Snowflake) -> None:
    '''
    Deletes a global command. Returns `204`.
    '''
    await Client.api_call(path = f"/applications/{application_id}/commands/{command_id}", method = "DELETE")

async def get_guild_application_commands(Client, application_id: Snowflake, guild_id: Snowflake) -> List[Application_Command]:
    '''
    ...
    '''
    r = await Client.api_call(path = f"/applications/{application_id}/guilds/{guild_id}/commands", method = "GET")
    return [Application_Command(**i) for i in r]

async def create_guild_application_command(Client, application_id: Snowflake, guild_id: Snowflake, name: str, description: str, options: List[Application_Command_Option]=[]) -> Application_Command:
    '''
    > danger
    > Creating a command with the same name as an existing command for your application will overwrite the old command.
    ...
    Params:
        ...
        :options: the parameters for the command
    '''
    r = await Client.api_call(path = f"/applications/{application_id}/guilds/{guild_id}/commands", method = "POST", json = {"name": name, "description": description, "options": options})
    return Application_Command(**r)

async def edit_guild_application_command(Client, application_id: Snowflake, guild_id: Snowflake, command_id: Snowflake, name: str, description: str, options: List[Application_Command_Option]=[]) -> Application_Command:
    '''
    ...
    Params:
        ...
        :options: the parameters for the command
    '''
    r = await Client.api_call(path = f"/applications/{application_id}/guilds/{guild_id}/commands/{command_id}", method = "PATCH", json = {"name": name, "description": description, "options": options})
    return Application_Command(**r)

async def delete_guild_application_command(Client, application_id: Snowflake, guild_id: Snowflake, command_id: Snowflake) -> None:
    '''
    Delete a guild command. Returns `204` on success.
    '''
    await Client.api_call(path = f"/applications/{application_id}/guilds/{guild_id}/commands/{command_id}", method = "DELETE")

async def create_interaction_response(Client, interaction_id: Snowflake, interaction_token: int, response: Interaction_Response) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/interactions/{interaction_id}/{interaction_token}/callback", method = "POST", json = as_dict(response))

async def edit_original_interaction_response(Client, application_id: Snowflake, interaction_token: int, content: str = None, embeds: List[Embed] = None, allowed_mentions: Allowed_Mentions = None) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/webhooks/{application_id}/{interaction_token}/messages/@original", method = "PATCH", json={"content":content, "embeds": embeds, "allowed_mentions": allowed_mentions})

async def delete_original_interaction_response(Client, application_id: Snowflake, interaction_token: int) -> None:
    '''
    Deletes the initial Interaction response. Returns `204` on success.
    '''
    await Client.api_call(path = f"/webhooks/{application_id}/{interaction_token}/messages/@original", method = "DELETE")

async def create_followup_message(Client, application_id: Snowflake, interaction_token: int, wait: bool = False, content: str = None, username: str = None, avatar_url: str = None, tts: bool = None, file: bytes = None, filename: str="file.txt", embeds: List[Embed] = None, payload_json: str = None, allowed_mentions: Allowed_Mentions = []) -> Message:
    '''
    ...
    '''
    r = await Client.api_call(path=f"/webhooks/{application_id}/{interaction_token}", method="POST", params={"wait": wait}, json={"content": content, "username": username, "avatar_url": avatar_url, "tts": tts, "embeds": embeds, "payload_json": payload_json, "allowed_mentions": allowed_mentions}, file=file, filename=filename)
    return Message(**r)

async def edit_followup_message(Client, application_id: Snowflake, interaction_token: int, message_id: Snowflake, content: str = None, embeds: List[Embed] = None, allowed_mentions: Allowed_Mentions = []) -> None:
    '''
    ...
    '''
    await Client.api_call(path = f"/webhooks/{application_id}/{interaction_token}/messages/{message_id}", method = "PATCH", json={"content":content, "embeds": embeds, "allowed_mentions": allowed_mentions})

async def delete_followup_message(Client, application_id: Snowflake, interaction_token: int, message_id: Snowflake) -> None:
    '''
    Deletes a followup message for an Interaction. Returns `204` on success.
    '''
    await Client.api_call(path=f"/webhooks/{application_id}/{interaction_token}/messages/{message_id}", method="DELETE")
