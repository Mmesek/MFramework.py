...
class Database:
    ...
    async def createTables(self):
        ...
        if await self.single() == (1,):
            return
        await self.access('''CREATE TABLE `Servers`(
            ...
            NoExpRoles BLOB,
            NoExpChannels BLOB)''')
        await self.access('''CREATE TABLE `Regex`(
            GuildID INT,
            Trigger TEXT,
            Response TEXT,
            ReqRole TEXT,
        ...
        await self.access('''CREATE TABLE `ReactionRoles`(
            GuildID INT,
            ChannelID INT,
            MessageID INT,
            RoleID INT,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `LevelRoles`(
            GuildID INT,
            Level INT,
            Role INT,
            Stacked BOOL,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `UserLevels`(
            GuildID INT,
            UserID INT,
            EXP INT,
            vEXP INT,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `Infractions`(
            GuildID INT,
            UserID INT,
            Timestamp INT,
            Reason TEXT,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `Webhooks`(
            GuildID INT,
            Webhook TEXT,
            Source TEXT,
            Content TEXT,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `RSS`(
            Source TEXT PRIMARY KEY,
            Last INT,
            URL TEXT,
            Color INT,
            Language TEXT)''')
        await self.access('''CREATE TABLE `Spotify`(
            SpotifyID TEXT PRIMARY KEY,
            Artist TEXT,
            AddedBy INT)''')
        await self.access('''CREATE TABLE `Giveaways`(
            GuildID INT,
            ChannelID INT,
            MessageID INT,
            UserID INT,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `EmbedTemplates`(
            GuildID INT,
            UserID INT,
            Name TEXT,
            Message TEXT,
            ...
            FOREIGN KEY(GuildID) REFERENCES Servers(GuildID))''')
        await self.access('''CREATE TABLE `Games`(
            UserID INT,
            Title TEXT,
            LastPlayed INT)''')
        await self.access('''CREATE TABLE `ActionLog`(
            GuildID INT,
            UserID INT,
            Timestamp INT,
            Action TEXT,
            Details TEXT)''')
        await self.access('''CREATE TABLE `RPSessionPlayers`(
            GuildID INT,
            HostID INT,
            PlayerID INT,
            Campaign TEXT)''')
